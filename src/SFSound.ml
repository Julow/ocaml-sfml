...
external setPosition: sound:u -> pos:float * float * float -> unit = "caml_sfSound_setPosition3"
external setPosition3: sound:u -> x:float -> y:float -> z:float -> unit = "caml_sfSound_setPosition"
